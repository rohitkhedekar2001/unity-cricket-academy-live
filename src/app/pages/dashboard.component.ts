      ...
      <div class="grid gap-4 lg:grid-cols-2">
        <section class="panel p-4">
          ...
          <div class="mt-3 divide-y divide-neutral-100">
            ...
            <div *ngFor="let fee of fees().slice(0, 8)" class="flex items-center justify-between py-3 text-sm">
              <span class="font-medium">{{ fee.month }} · {{ fee.fee_plan_name }}</span>
              <span class="font-bold text-academy-red">{{ money(fee.amount) }}</span>
            </div>
          </div>
        </section>
        <section class="panel p-4">
